...
> {
  ...
  componentDidCatch(error: Error, errorInfo: ErrorInfo): void {
    // Attach a marker so we can detect errors caught by this boundary
    (error as any).__ErrorBoundary = true;

    // Optional global callback for centralized error logging
    if (typeof window !== "undefined" && window.__COMPONENT_ERROR__) {
